...
int fungsiKompres(char karakter[], int panjang) {/*fungsi untuk melakukan kompresi mempunyai parameter 
    ...
    while( i < panjang) { /*looping jika nilai var i < panjang array awal*/
        ...
        if (jumlahChar > 1 || jumlahChar == 1) {/*jika jumlahChar lebih dari 1 atau sama dengan 1 maka akan dikompresi*/
        ...
        i++;/*pindah mengecheck karakter berikutnya*/
    }
...
int main() {
    ...
    char chars[panjangArray];/*deklarasi array chars yang bertipe data char dengan panjang panjangArray*/
